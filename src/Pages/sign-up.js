        ...
        <div className="col-md-4 mx-auto">
          <div className="osahan-login py-4">
            ...
            <form onSubmit={SignUp}>
             ...
             <a className="btn btn-block text-uppercase" href="/bussinessign-in"style={{backgroundColor:"purple"}} > Quero contratar </a> 
              <a className="btn btn-block text-uppercase" style={{backgroundColor:"green"}} href="#"> Quero ensinar </a> 
