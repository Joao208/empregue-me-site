...
<div>
  ...
  <title>Politica de Privacidade Empregue.me</title>
  {/* Slick Slider */}
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-8 mx-auto">
          <h1 className="text-white font-weight-light"><span className="font-weight-bold">Privacy</span> &amp; Policy</h1>
  ...
  <div className="py-5">
    <div className="container">
      <div className="row">
        <div className="col-md-8 mx-auto">
          <div className="bg-white p-5 shadow-sm box border rounded">
