    ...
    <div className="container">
      <div className="row align-items-center py-4">
        <div className="col-md-6">
          <h1 className="text-primary display-4 font-weight-bold">Como os<br />assistentes do Empregue.me podem<span className="text-warning">ajudar</span> você?</h1>
          <h5 className="mb-2 text-dark-50 font-weight-light">Gostariamos muito de ajudar você
          </h5>
        </div>
