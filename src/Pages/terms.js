...
<div>
  ...
  <title>Termos Empregue.me</title>
  {/* Slick Slider */}
        ...
        <div className="col-md-9">
          <div id="intro" className="mb-4">
            ...
            <div className="border-bottom pb-5 mb-5">
              <h1 className="text-primary font-weight-light"><span className="font-weight-bold">Osahanin</span> Terms &amp; conditions</h1>
              <p className="mb-0">Effective date: 1 January 2020</p>
            </div>
            {/* End Title */}
            {/* Title */}
            <div className="mb-3">
              <h2 className="h5">Welcome to Osahanin</h2>
            </div>
            {/* End Title */}
            <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Osahanin"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
            </p>
          ...
          <div id="services" className="mb-4">
            ...
            <ul className="text-secondary">
              <li className="pb-2">When you register for a Osahanin account we collect your full name, email address, and account log-in credentials.</li>
              ...
              <li className="pb-2">When you use the "Remember Me" feature of Osahanin Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
            </ul>
          ...
          <div id="privacy" className="mb-4">
            ...
            <p>We provide information to help copyright holders manage their intellectual property online. If you think somebody is violating your copyrights and want to notify us, you can find information about submitting notices and Osahanin's policy about responding to notices in <a href="help">our Help Center</a>.</p>
          </div>
        ...
        <div className="col-md-3">
          <div className="mb-3 border rounded list-sidebar overflow-hidden">
            ...
            <ul className="list-group list-group-flush">
              <li className="active">
                <a className="list-group-item p-3 list-group-item-action font-weight-medium text-primary" href="#services">1. Using our services</a>
                <ul className="list-group list-group-flush py-3 pl-5">
                  <li>
                    <a className="list-group-item-action" href="#personal-data">A. Personal Data that we collect about you</a>
                  </li>
                  <li className="mt-3">
                    <a className="list-group-item-action" href="#information">B. Information that we collect automatically on our Sites</a>
                  </li>
                </ul>
              </li>
              <li className="list-group-item list-group-item-action p-3">
                <a className="list-group-item-action" href="#privacy">2. Privacy and copyright protection</a>
              </li>
              <li className="list-group-item list-group-item-action p-3">
                <a className="list-group-item-action" href="#yourContent">3. Your content in our services</a>
              </li>
            </ul>
          </div>
        </div>
