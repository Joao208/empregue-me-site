                      ...
                      <a >
                        <div className="border job-item mb-3">
                          ...
                          <div className="overflow-hidden mr-2">
                             <a href={`https://light-empregue-me.herokuapp.com/job-profile/${vacancies._id}`}><h6 style={{textTransform:'autocapitalize'}} className="font-weight-bold text-dark mb-0 text-truncate">{vacancies.text.title}</h6></a>
