      ...
      <div className="row">
        ...
        <main className="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
          ...
          <div className="box shadow-sm border rounded bg-white mb-3 osahan-post">
            ...
            <iframe 
            src={`https://maps.google.com/maps?width=100%&amp;height=100%&amp;hl=en&amp;coord=${check.latitude},${check.longitude}&amp;q=1%20Grafton%20Street%2C%20Dublin%2C%20Ireland+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed`} 
            width="100%" 
            height="100%" 
            frameborder="0" 
            style={{border:'none'}} 
